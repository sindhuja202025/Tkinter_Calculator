...
for b in buttons:
    ...
    tk.Button(root, text=b, command=cmd,font=("Segoe UI",14),
              width=5, height=2,bg="#ff9500" if b in "+-*/=" else "#3a3a3a",fg="white",bd=0).grid(row=r, column=c, padx=6, pady=6)
    c +=1
    if c==4:
        c=0
        r+=1
